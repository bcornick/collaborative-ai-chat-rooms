        ...
        {messages.length > 0 ? (
          <>
            ...
            <p className="text-stone-400">
              Want more info? Try telling the chatbot to &quot;elaborate&quot;
            </p>
          </>
        ) : (
        ...
        {session.status === 'authenticated' ? (
          <form
            ...
            <input
              ...
              className="border border-stone-400 p-3 bg-stone-100 min-w-full rounded dark:bg-gray-900"
              type="text"
              name="message"></input>
          </form>
        ) : session.status === 'unauthenticated' ? (
          <div className="sticky left-4 sm:left-6 bottom-4 sm:bottom-6 pt-2 rounded-sm flex items-start">
            <p className="bg-red-100 p-3 dark:bg-fuchsia-800">
